...
func crearTask(w http.ResponseWriter, r *http.Request) {
	...
	// Si el estado o prioridad vienen vacíos, podemos poner defaults (opcional)
	if nueva.Estado == "" {
